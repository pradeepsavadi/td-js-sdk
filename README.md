...
!function(t,e){if(void 0===e[t]){e[t]=function(){e[t].clients.push(this),this._init=[Array.prototype.slice.call(arguments)]},e[t].clients=[];for(var n=function(t){return function(){return this["_"+t]=this["_"+t]||[],this["_"+t].push(Array.prototype.slice.call(arguments)),this}},o=["blockEvents","fetchServerCookie","unblockEvents","setSignedMode","setAnonymousMode","resetUUID","addRecord","fetchGlobalID","set","trackEvent","trackPageview","trackClicks","ready"],r=0;r<o.length;r++){var i=o[r];e[t].prototype[i]=n(i)}var c,a,s,d,l=document.createElement("iframe");l.src="javascript:false",l.title="",l.role="presentation",l.loading="eager",d=(l.frameElement||l).style,d.width=0,d.height=0,d.border=0,d.display="none",s=document.currentScript||document.getElementsByTagName("script")[0],s.parentNode.insertBefore(l,s);try{a=l.contentWindow.document}catch(p){c=document.domain,l.src='javascript:var d=document.open();d.domain="'+c+'";void(0);',a=l.contentWindow.document}a.open()._loadScript=function(){var t=this.createElement("script");c&&(this.domain=c),t.id="td-js-iframe",t.src=("https:"===document.location.protocol?"https:":"http:")+"//cdn.treasuredata.com/sdk/2.2/td.min.js",this.body.appendChild(t)},a.write('<body onload="document._loadScript();">'),a.close()}}("Treasure",this);
</script>
```
